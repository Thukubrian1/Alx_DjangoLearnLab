...
SECRET_KEY = 'django-insecure-zy(x$gb5f$s!ih-3g!i&*wo7cm$q)$1+g-b)1ayc26*uj5yjz3'
...
INSTALLED_APPS += ['csp']
CSP_DEFAULT_SRC = ("'self'",)  # Restrict content sources to the same domain
CSP_SCRIPT_SRC = ("'self'", 'trusted-scripts.example.com')  # Allow only trusted script sources
